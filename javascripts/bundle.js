...
var Root = exports.Root = function Root(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_feature2.default, {
      ...
      body: 'A nostalgic rendition of the age-old classic. This version uses UTF-8 chess pieces and font colorization provided by the Colorize gem to construct a believable chess board out of command line output. Arrow key controls and responsive square highlighting evoke a retro user experience.'
    }),
    _react2.default.createElement(
      'div',
      { className: 'closing' },
